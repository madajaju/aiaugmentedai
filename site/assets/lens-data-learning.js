// Rich learning-hub stage data for generate-learning-stage-pages.mjs
window.AA_LENS_DATA = {
  "individual": {
    "title": "Individual",
    "stages": {
      "aware": {
        ...
        "summary": "Turn curiosity into a repeatable daily AI habit.",
        ...
        "diagnosis": {
          ...
          "description": "You are not behind. You are at the point where awareness needs to become a simple daily behavior.",
          "items": [
            "You have tried ChatGPT or another AI tool.",
            "You use AI occasionally, but not consistently.",
            "You know AI matters, but you are unsure where to begin.",
            "You still do most of your work manually.",
            "You are curious, but you do not yet have a repeatable workflow."
          ]
        },
        "mission": {
          "title": "Your mission this week",
          "description": "You do not need to master AI yet. You need one successful habit.",
          "steps": [
            "Pick one repetitive daily task.",
            "Use AI on that task every day this week.",
            "Keep a short note about what worked and what failed.",
            "Repeat before adding another AI use case."
          ]
        },
        "mistakes": [
          ...
          "Mistaking curiosity for capability.",
        ...
        "resources": {
          "available": [
            ...
            {
              "label": "Explore Individual Roadmap",
              "href": "/lens/individual/aaos/",
        ...
        "readyForNext": [
          "AI helps you with one task every day.",
          "You have one repeatable workflow.",
          "You are beginning to refine prompts.",
          "You understand AI needs human review."
        ],
        "nextStage": {
          "label": "Exploring",
          "description": "Move from occasional use to intentionally solving real work problems with AI."
        },
      ...
      "exploring": {
        ...
        "summary": "Narrow from experimentation to useful patterns.",
        ...
        "diagnosis": {
          ...
          "items": [
            ...
            "You are focused on: compare outputs from different models.",
            "You are focused on: document what actually saves time."
          ]
        },
        "mission": {
          "title": "Your mission this week",
          "description": "Do not try to master everything. Choose one practical behavior and repeat it until it becomes visible progress.",
          "steps": [
            "Standardize one workflow",
            "Compare outputs from different models",
            "Document what actually saves time"
        ...
        "mistakes": [
          "Do not accumulate prompts without deciding what is worth keeping."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Document three repeatable prompts that consistently produce reliable results for a specific task."
        ],
        "nextStage": {
          "label": "Experimenting",
          "description": "Move from Exploring toward Experimenting when the checklist is true."
        },
        "memberTitle": "Unlock the full stage experience",
        "memberDescription": "The free page gives orientation and one practical step. Membership unlocks the guided transformation path.",
      ...
      "experimenting": {
        ...
        "summary": "Turn isolated AI successes into dependable workflows.",
        ...
        "diagnosis": {
          "title": "Is this really you?",
          "description": "You are past casual use. Now the challenge is consistency, review, and repeatability.",
          "items": [
            "You reuse prompts instead of starting from scratch every time.",
            "You compare outputs and notice quality differences.",
            "You are learning which tasks AI should and should not touch.",
            "You still need stronger validation and review habits.",
            "You have useful experiments, but not yet a stable personal operating system."
          ]
        },
        "mission": {
          "title": "Your mission this week",
          "description": "Choose one workflow and make it dependable instead of merely interesting.",
          "steps": [
            "Choose one workflow: writing, research, meetings, coding, or content creation.",
            "Run the workflow at least three times this week.",
            "Document the prompt, the review step, and the failure points.",
            "Add one mandatory human validation step before final use."
          ]
        },
        "mistakes": [
          "Over-trusting outputs.",
          "Running too many disconnected experiments.",
          "Failing to document what works.",
          "Skipping validation because the answer sounds good.",
          "Assuming one prompt fits every task."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "AI is part of your normal work routine.",
          "You consistently validate important outputs.",
          "You have documented at least one repeatable workflow.",
          "You know where human review is required."
        ],
        "nextStage": {
          "label": "Integrating",
          "description": "AI becomes part of your operating system instead of another tool."
        },
        "memberTitle": "Unlock the full stage experience",
        "memberDescription": "The free page gives orientation and one practical step. Membership unlocks the guided transformation path.",
      ...
      "integrating": {
        ...
        "diagnosis": {
          ...
          "items": [
            ...
            "You are focused on: refine versioned templates.",
            "You are focused on: optimize for quality, not just speed."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let convenience weaken judgment or quality control."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Create a shared resource (guide, library, or checklist) that helps at least one peer adopt a similar workflow."
        ],
        "nextStage": {
          "label": "Leading",
          "description": "Move from Integrating toward Leading when the checklist is true."
        },
        "memberTitle": "Unlock the full stage experience",
        "memberDescription": "The free page gives orientation and one practical step. Membership unlocks the guided transformation path.",
      ...
      "leading": {
        ...
        "summary": "Influence consistency for others, not just yourself.",
        ...
        "stageNumber": 5,
        "duration": "ongoing",
        "heroText": "Peers ask how you use AI, you document good practice, and your workflow becomes a model others can follow.",
        ...
        "diagnosis": {
          ...
          "items": [
            ...
            "You are focused on: document peer success stories.",
            "You are focused on: establish shared quality standards."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not assume your workflow will transfer without explanation or support."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Redesign a core job function around AI-human partnership, where the outcome is significantly better than either could achieve alone."
        ],
        "nextStage": {
          "label": "Augmenting",
          "description": "Move from Leading toward Augmenting when the checklist is true."
        },
        "memberTitle": "Unlock the full stage experience",
        "memberDescription": "The free page gives orientation and one practical step. Membership unlocks the guided transformation path.",
      ...
      "augmenting": {
        ...
        "stageNumber": 6,
        "duration": "ongoing",
        "heroText": "Your work, decisions, and outputs are materially different because AI is woven into how you operate.",
        ...
        "diagnosis": {
          ...
          "items": [
            ...
            "You are focused on: audit your personal os regularly.",
            "You are focused on: maintain deep human judgment."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not confuse system-wide augmentation with tool adoption alone."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Regularly audit and refine your personal operating system to maintain high quality as AI models evolve."
        ],
        "nextStage": {
          "label": "Sustained Augmentation",
          "description": "Move from Augmenting toward Sustained Augmentation when the checklist is true."
        },
        "memberTitle": "Unlock the full stage experience",
        "memberDescription": "The free page gives orientation and one practical step. Membership unlocks the guided transformation path.",
  ...
  "team-leader": {
    ...
    "stages": {
      "aware": {
        ...
        "summary": "Make AI use visible and discussable.",
        ...
        "diagnosis": {
          ...
          "items": [
            "Different people use different tools and there is no shared way to judge quality yet.",
            "You are focused on: create a common language for ai.",
            "You are focused on: identify current 'shadow' ai use.",
            "You are focused on: discuss quality expectations."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let the team normalize random experimentation without standards."
        ],
        "resources": {
          "available": [
            {
            ...
            {
              "label": "Explore Team Leader Roadmap",
              "href": "/lens/team-leader/aaos/",
              "description": "See how this stage fits into the full AI-Augmented operating system."
            }
          ],
          "comingSoon": [
            "Aware stage video lesson",
            "Team Leader guided worksheet",
            "Prompt examples for this stage",
            "Community discussion thread",
            "Weekly challenge"
          ],
        ...
        "readyForNext": [
          "Establish a shared list of AI tools and have one team discussion about their use."
        ],
        "nextStage": {
          "label": "Exploring",
          "description": "Move from Aware toward Exploring when the checklist is true."
        },
        "memberTitle": "Unlock the full stage experience",
        "memberDescription": "The free page gives orientation and one practical step. Membership unlocks the guided transformation path.",
      ...
      "exploring": {
        ...
        "summary": "Move from individual trial to shared learning.",
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a team leader recognize where they are before asking them to take the next step.",
          "items": [
            "People share prompts and compare results, but workflows are still personal.",
            "You are focused on: choose one team workflow to adopt.",
            "You are focused on: standardize the core prompt.",
            "You are focused on: document learned patterns."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let experimentation become fragmentation."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Agree on one specific team task to be AI-assisted and document the shared prompt."
        ],
        "nextStage": {
          "label": "Experimenting",
          "description": "Move from Exploring toward Experimenting when the checklist is true."
      ...
      "experimenting": {
        ...
        "summary": "Make quality and review more reliable.",
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a team leader recognize where they are before asking them to take the next step.",
          "items": [
            "The team reuses prompts and starts to compare output quality across people.",
            "You are focused on: strengthen team consistency.",
            "You are focused on: implement review discipline.",
            "You are focused on: clarify ai ownership."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let good enough become the standard."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Implement a mandatory peer-review step for all AI-generated team outputs."
        ],
        "nextStage": {
          "label": "Integrating",
          "description": "Move from Experimenting toward Integrating when the checklist is true."
        },
        "memberTitle": "Unlock the full stage experience",
        "memberDescription": "The free page gives orientation and one practical step. Membership unlocks the guided transformation path.",
      ...
      "integrating": {
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a team leader recognize where they are before asking them to take the next step.",
          "items": [
            "The team uses AI for defined tasks and gets better output with less friction.",
            "You are focused on: make processes explicit.",
            "You are focused on: define mandatory review points.",
            "You are focused on: accelerate without losing quality."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let speed outrun review."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Create a team-wide library of \"Gold Standard\" prompt-output pairs."
        ],
        "nextStage": {
          "label": "Leading",
          "description": "Move from Integrating toward Leading when the checklist is true."
      ...
      "leading": {
        ...
        "summary": "Make the standard portable across people and projects.",
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a team leader recognize where they are before asking them to take the next step.",
          "items": [
            "The team can explain its AI workflow and onboard new members more quickly.",
            "You are focused on: teach the team standard.",
            "You are focused on: keep the team aligned.",
            "You are focused on: model responsible use."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not assume the workflow will survive without leadership and reinforcement."
        ],
        "resources": {
          "available": [
            {
      ...
      "augmenting": {
        ...
        "stageNumber": 6,
        "duration": "ongoing",
        "heroText": "AI is built into how the team delivers results, collaborates, and measures quality.",
        "nextMilestone": "Regularly review team metrics to ensure AI is increasing velocity without sacrificing quality.",
        "diagnosis": {
          "title": "Is this really you?",
          "description": "This stage page helps a team leader recognize where they are before asking them to take the next step.",
          "items": [
            "AI is built into how the team delivers results, collaborates, and measures quality.",
            "You are focused on: keep team standards strong.",
            "You are focused on: review team metrics regularly.",
            "You are focused on: maintain human-centered judgment."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let the team confuse novelty with progress."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Regularly review team metrics to ensure AI is increasing velocity without sacrificing quality."
        ],
        "nextStage": {
          "label": "Sustained Augmentation",
          "description": "Move from Augmenting toward Sustained Augmentation when the checklist is true."
  ...
  "organization-leader": {
    ...
    "stages": {
      "aware": {
        ...
        "summary": "Create a common view of the opportunity and the risk.",
        ...
        "diagnosis": {
          ...
          "items": [
            "Different teams are using AI differently and there is no shared definition of success.",
            "You are focused on: define the operating standard.",
            "You are focused on: set clear risk boundaries.",
            "You are focused on: establish leadership alignment."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let disconnected pilots define the orgs future."
        ],
        "resources": {
          "available": [
            {
            ...
            {
              "label": "Explore Organization Leader Roadmap",
              "href": "/lens/organization-leader/aaos/",
              "description": "See how this stage fits into the full AI-Augmented operating system."
            }
          ],
          "comingSoon": [
            "Aware stage video lesson",
            "Organization Leader guided worksheet",
            "Prompt examples for this stage",
            "Community discussion thread",
            "Weekly challenge"
          ],
        ...
        "readyForNext": [
          "Publish a clear AI Acceptable Use Policy that defines high-level risk boundaries."
        ],
        "nextStage": {
          "label": "Exploring",
          "description": "Move from Aware toward Exploring when the checklist is true."
      ...
      "exploring": {
        ...
        "summary": "Reduce variance and identify what should scale.",
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a organization leader recognize where they are before asking them to take the next step.",
          "items": [
            "A few teams are trying AI and leadership is gathering examples of value and risk.",
            "You are focused on: decide what should be standardized.",
            "You are focused on: identify high-priority pilots.",
            "You are focused on: track cross-functional value."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let experimentation outrun governance."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Identify and launch two high-priority cross-functional pilots."
        ],
        "nextStage": {
          "label": "Experimenting",
          "description": "Move from Exploring toward Experimenting when the checklist is true."
      ...
      "experimenting": {
        ...
        "summary": "Turn experiments into a managed path.",
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a organization leader recognize where they are before asking them to take the next step.",
          "items": [
            "Teams are producing examples that can be compared and refined.",
            "You are focused on: translate pilots into patterns.",
            "You are focused on: establish central repository.",
            "You are focused on: avoid pilot fragmentation."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not over-favor the loudest pilot over the most durable one."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Establish a centralized repository for pilot outcomes and lessons learned."
        ],
        "nextStage": {
          "label": "Integrating",
          "description": "Move from Experimenting toward Integrating when the checklist is true."
      ...
      "integrating": {
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a organization leader recognize where they are before asking them to take the next step.",
          "items": [
            "Teams are using AI within clear guidelines and quality expectations.",
            "You are focused on: scale with consistency.",
            "You are focused on: embed governance checks.",
            "You are focused on: maintain visible accountability."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let local success create inconsistent enterprise behavior."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Embed AI governance checks into the standard project approval workflow."
        ],
        "nextStage": {
          "label": "Leading",
          "description": "Move from Integrating toward Leading when the checklist is true."
      ...
      "leading": {
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a organization leader recognize where they are before asking them to take the next step.",
          "items": [
            "Leaders can explain the standard, and teams have a common expectation for use.",
            "You are focused on: teach the organizational standard.",
            "You are focused on: align incentives across teams.",
            "You are focused on: maintain explicit review points."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let policy exist without practical enablement."
        ],
        "resources": {
          "available": [
            {
      ...
      "augmenting": {
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a organization leader recognize where they are before asking them to take the next step.",
          "items": [
            "The organizations work, performance, and decision-making are changing because AI is embedded in the model.",
            "You are focused on: keep transformation human-centered.",
            "You are focused on: conduct annual strategic reviews.",
            "You are focused on: preserve oversight at scale."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let scale erode accountability."
        ],
        "resources": {
          "available": [
            {
  ...
  "student": {
    ...
    "stages": {
      "aware": {
        ...
        "summary": "Connect AI to learning and future readiness.",
        ...
        "diagnosis": {
          "title": "Is this really you?",
          "description": "This stage page helps a student recognize where they are before asking them to take the next step.",
          "items": [
            "You have tried AI a few times and are starting to think about how it changes study, writing, and future work.",
            "You are focused on: support understanding, don't replace learning.",
            "You are focused on: identify one complex concept to explain.",
            "You are focused on: check your work against ai outputs."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not confuse quick answers with actual skill."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Use AI to explain one complex concept you are struggling to understand."
        ],
        "nextStage": {
          "label": "Exploring",
          "description": "Move from Aware toward Exploring when the checklist is true."
      ...
      "exploring": {
        ...
        "summary": "Find practical use without over-relying on it.",
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a student recognize where they are before asking them to take the next step.",
          "items": [
            "You compare outputs, ask follow-up questions, and start to notice when AI is helpful versus distracting.",
            "You are focused on: pick repeatable academic tasks.",
            "You are focused on: generate study guides or quizzes.",
            "You are focused on: validate facts and sources."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not outsource learning or skip the thinking part."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Use AI to generate a study guide or practice quiz for one of your courses."
        ],
        "nextStage": {
          "label": "Experimenting",
          "description": "Move from Exploring toward Experimenting when the checklist is true."
      ...
      "experimenting": {
        ...
        "summary": "Make the practice stronger and more trustworthy.",
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a student recognize where they are before asking them to take the next step.",
          "items": [
            "You have workflows for notes, drafts, research, or practice questions that you reuse.",
            "You are focused on: strengthen your workflow and your verification habits.."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let convenience weaken your judgment or skill building."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Document how you validated the sources for one AI-assisted research project."
        ],
        "nextStage": {
          "label": "Integrating",
          "description": "Move from Experimenting toward Integrating when the checklist is true."
      ...
      "integrating": {
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a student recognize where they are before asking them to take the next step.",
          "items": [
            "You move from idea to draft to revision faster and more confidently.",
            "You are focused on: make your study and work habits more repeatable.."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let speed erode depth or originality."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Develop a repeatable workflow for note-taking and exam prep using AI."
        ],
        "nextStage": {
          "label": "Leading",
          "description": "Move from Integrating toward Leading when the checklist is true."
      ...
      "leading": {
        ...
        "summary": "Model responsible, effective use.",
        ...
        "stageNumber": 5,
        "duration": "ongoing",
        "heroText": "Peers ask how you work, and your habits are a good example for others.",
        "nextMilestone": "Share your AI study workflow and validation checklist with a study group.",
        "diagnosis": {
          "title": "Is this really you?",
          "description": "This stage page helps a student recognize where they are before asking them to take the next step.",
          "items": [
            "Peers ask how you work, and your habits are a good example for others.",
            "You are focused on: teach the practice, not just the tool.."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not assume everyone is starting from the same place."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Share your AI study workflow and validation checklist with a study group."
        ],
        "nextStage": {
          "label": "Augmenting",
          "description": "Move from Leading toward Augmenting when the checklist is true."
      ...
      "augmenting": {
        ...
        "stageNumber": 6,
        "duration": "ongoing",
        "heroText": "Your study habits, output quality, and confidence are materially different because AI is built into how you operate.",
        "nextMilestone": "Regularly review your learning progress to ensure AI is deepening your understanding, not just saving time.",
        "diagnosis": {
          "title": "Is this really you?",
          "description": "This stage page helps a student recognize where they are before asking them to take the next step.",
          "items": [
            "Your study habits, output quality, and confidence are materially different because AI is built into how you operate.",
            "You are focused on: keep your learning deep while the tools get better.."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not mistake tool fluency for real mastery."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Regularly review your learning progress to ensure AI is deepening your understanding, not just saving time."
        ],
        "nextStage": {
          "label": "Sustained Augmentation",
          "description": "Move from Augmenting toward Sustained Augmentation when the checklist is true."
  ...
  "teacher": {
    ...
    "stages": {
      "aware": {
        ...
        "summary": "Connect AI to teaching, learning, and trust.",
        ...
        "diagnosis": {
          "title": "Is this really you?",
          "description": "This stage page helps a teacher recognize where they are before asking them to take the next step.",
          "items": [
            "You are seeing student use of AI and wondering how it should change your classroom.",
            "You are focused on: identify help vs. threat in learning.",
            "You are focused on: draft one lesson plan with ai.",
            "You are focused on: review ai outputs for bias."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not react only with restriction."
        ],
        "resources": {
          "available": [
            {
            ...
            {
              "label": "Explore Teacher Roadmap",
              "href": "/lens/teacher/aaos/",
              "description": "See how this stage fits into the full AI-Augmented operating system."
            }
          ],
          "comingSoon": [
        ...
        "readyForNext": [
          "Use AI to draft one lesson plan or assessment rubric and review it for bias."
        ],
        "nextStage": {
          "label": "Exploring",
          "description": "Move from Aware toward Exploring when the checklist is true."
      ...
      "exploring": {
        ...
        "summary": "Improve the work without weakening the learning.",
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a teacher recognize where they are before asking them to take the next step.",
          "items": [
            "You try AI for lesson planning, feedback ideas, and assignment redesign.",
            "You are focused on: choose one high-impact workflow.",
            "You are focused on: design an ai-guided assignment.",
            "You are focused on: maintain academic rigor."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let AI blur learning objectives or reduce rigor."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Design one assignment that explicitly allows (and guides) student AI use."
        ],
        "nextStage": {
          "label": "Experimenting",
          "description": "Move from Exploring toward Experimenting when the checklist is true."
      ...
      "experimenting": {
        ...
        "summary": "Keep teaching reliable and consistent.",
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a teacher recognize where they are before asking them to take the next step.",
          "items": [
            "You have a few repeatable ways to use AI for planning, feedback, or classroom design.",
            "You are focused on: turn the best experiments into a classroom standard.."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not use AI in ways that hide student thinking."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Create a standard feedback loop where AI drafts initial comments for your review."
        ],
        "nextStage": {
          "label": "Integrating",
          "description": "Move from Experimenting toward Integrating when the checklist is true."
      ...
      "integrating": {
        ...
        "diagnosis": {
          ...
          "description": "This stage page helps a teacher recognize where they are before asking them to take the next step.",
          "items": [
            "You have a clear workflow for using AI in planning, feedback, and communication.",
            "You are focused on: make your use transparent and repeatable.."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let convenience reduce the quality of student engagement."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Build a library of AI-integrated lesson plans for your entire curriculum."
        ],
        "nextStage": {
          "label": "Leading",
          "description": "Move from Integrating toward Leading when the checklist is true."
      ...
      "leading": {
        ...
        "summary": "Make responsible AI use teachable to peers and students.",
        ...
        "stageNumber": 5,
        "duration": "ongoing",
        "heroText": "Other teachers ask how you structure AI use and how you keep standards clear.",
        "nextMilestone": "Lead a professional development session for peers on responsible AI integration.",
        "diagnosis": {
          "title": "Is this really you?",
          "description": "This stage page helps a teacher recognize where they are before asking them to take the next step.",
          "items": [
            "Other teachers ask how you structure AI use and how you keep standards clear.",
            "You are focused on: teach the method and the reasoning behind it.."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let one teachers practice become the only model."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Lead a professional development session for peers on responsible AI integration."
        ],
        "nextStage": {
          "label": "Augmenting",
          "description": "Move from Leading toward Augmenting when the checklist is true."
      ...
      "augmenting": {
        ...
        "stageNumber": 6,
        "duration": "ongoing",
        "heroText": "Your assignments, feedback loops, and classroom routines are materially different because AI is integrated into the work.",
        "nextMilestone": "Regularly audit your assignments to ensure they still measure true student understanding in an AI-rich environment.",
        "diagnosis": {
          "title": "Is this really you?",
          "description": "This stage page helps a teacher recognize where they are before asking them to take the next step.",
          "items": [
            "Your assignments, feedback loops, and classroom routines are materially different because AI is integrated into the work.",
            "You are focused on: maintain rigor while using ai to expand what students can do.."
          ]
        },
        "mission": {
          "title": "Your mission this week",
        ...
        "mistakes": [
          "Do not let AI obscure student understanding."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Regularly audit your assignments to ensure they still measure true student understanding in an AI-rich environment."
        ],
        "nextStage": {
          "label": "Sustained Augmentation",
          "description": "Move from Augmenting toward Sustained Augmentation when the checklist is true."
  ...
  "education-administrator": {
    ...
    "stages": {
      "aware": {
        ...
        "summary": "Connect AI to strategy, policy, and student outcomes.",
        ...
        "mistakes": [
          "Do not let isolated pilots define the institution."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Form a cross-functional AI task force to draft an institutional guidance document."
        ],
        "nextStage": {
          "label": "Exploring",
          "description": "Move from Aware toward Exploring when the checklist is true."
      ...
      "exploring": {
        ...
        "summary": "Reduce confusion and establish direction.",
        ...
        "mistakes": [
          "Do not let variation become the norm without oversight."
        ],
        "resources": {
          "available": [
            {
      ...
      "experimenting": {
        ...
        "mistakes": [
          "Do not let promising pilots bypass review or governance."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Publish a set of \"Safe harbor\" guidelines for faculty experimentation."
        ],
        "nextStage": {
          "label": "Integrating",
          "description": "Move from Experimenting toward Integrating when the checklist is true."
      ...
      "integrating": {
        ...
        "mistakes": [
          "Do not let separate teams create incompatible standards."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Standardize AI policy across all academic programs and departments."
        ],
        "nextStage": {
          "label": "Leading",
          "description": "Move from Integrating toward Leading when the checklist is true."
      ...
      "leading": {
        ...
        "mistakes": [
          "Do not let policy remain disconnected from implementation."
        ],
        "resources": {
          "available": [
            {
      ...
      "augmenting": {
        ...
        "mistakes": [
          "Do not let scale reduce accountability."
        ],
        "resources": {
          "available": [
            {
        ...
        "readyForNext": [
          "Integrate AI readiness into the institution's long-term strategic plan and budget."
        ],
        "nextStage": {
          "label": "Sustained Augmentation",
          "description": "Move from Augmenting toward Sustained Augmentation when the checklist is true."
